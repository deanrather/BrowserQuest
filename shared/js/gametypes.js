...
Types = {
    ...
    // },
    Messages: {
        CREATE: 'BQ_MESSAGE_CREATE',
        LOGIN: 'BQ_MESSAGE_LOGIN',
        WELCOME: 'BQ_MESSAGE_WELCOME',
        SPAWN: 'BQ_MESSAGE_SPAWN',
        DESPAWN: 'BQ_MESSAGE_DESPAWN',
        MOVE: 'BQ_MESSAGE_MOVE',
        LOOTMOVE: 'BQ_MESSAGE_LOOTMOVE',
        AGGRO: 'BQ_MESSAGE_AGGRO',
        ATTACK: 'BQ_MESSAGE_ATTACK',
        HIT: 'BQ_MESSAGE_HIT',
        HURT: 'BQ_MESSAGE_HURT',
        HEALTH: 'BQ_MESSAGE_HEALTH',
        CHAT: 'BQ_MESSAGE_CHAT',
        LOOT: 'BQ_MESSAGE_LOOT',
        EQUIP: 'BQ_MESSAGE_EQUIP',
        DROP: 'BQ_MESSAGE_DROP',
        TELEPORT: 'BQ_MESSAGE_TELEPORT',
        DAMAGE: 'BQ_MESSAGE_DAMAGE',
        POPULATION: 'BQ_MESSAGE_POPULATION',
        KILL: 'BQ_MESSAGE_KILL',
        LIST: 'BQ_MESSAGE_LIST',
        WHO: 'BQ_MESSAGE_WHO',
        ZONE: 'BQ_MESSAGE_ZONE',
        DESTROY: 'BQ_MESSAGE_DESTROY',
        HP: 'BQ_MESSAGE_HP',
        BLINK: 'BQ_MESSAGE_BLINK',
        OPEN: 'BQ_MESSAGE_OPEN',
        CHECK: 'BQ_MESSAGE_CHECK',
        PVP: 'BQ_MESSAGE_PVP',
        GUILD: 'BQ_MESSAGE_GUILD',
        GUILDERROR: 'BQ_MESSAGE_GUILDERROR',
        GUILDERRORTYPE: {
            DOESNOTEXIST: 'BQ_MESSAGE_GUILDERRORTYPE_DOESNOTEXIST',
            BADNAME: 'BQ_MESSAGE_GUILDERRORTYPE_BADNAME',
            ALREADYEXISTS: 'BQ_MESSAGE_GUILDERRORTYPE_ALREADYEXISTS',
            NOLEAVE: 'BQ_MESSAGE_GUILDERRORTYPE_NOLEAVE',
            BADINVITE: 'BQ_MESSAGE_GUILDERRORTYPE_BADINVITE',
            GUILDRULES: 'BQ_MESSAGE_GUILDERRORTYPE_GUILDRULES',
            IDWARNING:'BQ_MESSAGE_GUILDERRORTYPE_IDWARNING'
        },
        GUILDACTION: {
            CONNECT: 'BQ_MESSAGE_GUILDACTION_CONNECT',
            ONLINE: 'BQ_MESSAGE_GUILDACTION_ONLINE',
            DISCONNECT: 'BQ_MESSAGE_GUILDACTION_DISCONNECT',
            INVITE: 'BQ_MESSAGE_GUILDACTION_INVITE',
            LEAVE: 'BQ_MESSAGE_GUILDACTION_LEAVE',
            CREATE: 'BQ_MESSAGE_GUILDACTION_CREATE',
            TALK: 'BQ_MESSAGE_GUILDACTION_TALK',
            JOIN: 'BQ_MESSAGE_GUILDACTION_JOIN',
            POPULATION: 'BQ_MESSAGE_GUILDACTION_POPULATION'
        }
    },
